...
GEAR_Y_MAP = {
    "up_max": 125,   # up if gy <= 125
    "down_min": 140  # down if gy >= 140
}
INVERT_GX    = True
X_RIGHT_MAX  = 104
X_CENTER_MIN = 110
...
def aggiorna_gamepad(throttle=None, brake=None, asse_x=None):
    if gamepad is None:
        return

    # Steering: negativo = sinistra, positivo = destra
