...
SERIAL_PORT = 'COM6'
BAUD_RATE = 115200
DEBUG_SERIAL_LOGS = False  # mostra tutte le righe della seriale
DEBUG_RAW_GXGY = False     # mostra solo i valori gx/gy (disattivo di default)
...
GEAR_Y_MAP = {"up_max": 125, "down_min": 135}  # gy<=125=up / gy>=135=down
INVERT_GX = True
X_RIGHT_MAX = 115   # gx<=115 -> right (5/R)
X_CENTER_MIN = 116  # center (3/4)
X_CENTER_MAX = 175
X_LEFT_MIN = 176    # gx>=176 -> left (1/2)
